...
const CardWhere = ({ image, title, description, Icon }: Props) => {
  return (
    <div className="border-2 rounded-md overflow-hidden shadow-md xl:max-w-[400px] hover:-translate-y-3 duration-75">
      <figure className="relative    overflow-hidden">
        <div className="relative aspect-[6/3] w-full hover:scale-110 duration-75">
          <Image
            src={image}
